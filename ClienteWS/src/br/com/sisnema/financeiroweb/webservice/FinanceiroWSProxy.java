...
public class FinanceiroWSProxy implements br.com.sisnema.financeiroweb.webservice.FinanceiroWS {
  private String _endpoint = null;
  private br.com.sisnema.financeiroweb.webservice.FinanceiroWS financeiroWS = null;
  ...
  private void _initFinanceiroWSProxy() {
    try {
      financeiroWS = (new br.com.sisnema.financeiroweb.webservice.FinanceiroWSServiceLocator()).getFinanceiroWSPort();
  ...
  public br.com.sisnema.financeiroweb.webservice.FinanceiroWS getFinanceiroWS() {
    if (financeiroWS == null)
      _initFinanceiroWSProxy();
    return financeiroWS;
  }
